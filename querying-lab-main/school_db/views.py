...
def problem_two(request):
    instructors= Instructor.objects.filter(hire_date__gte=2010).order_by('+ hire_date')
...
def problem_three(request):
    instructors= Instructor.objects.filter(instructor=2)
    for instructor in instructors:
      print(f'{instructor.first_name}  {instructor.last_name} {instructor.course}') 
